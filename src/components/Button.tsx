...
export default function Button({
  ...
  const variantStyles = {
    ...
    secondary: `bg-[var(--accent-cyan)] text-[var(--background)] hover:bg-[#19c6e0] hover:-translate-y-1 
      shadow-md hover:shadow-lg hover:shadow-[var(--accent-cyan)]/30 active:translate-y-0 
      active:shadow-sm active:bg-opacity-90 relative 
      after:absolute after:inset-0 after:rounded-lg after:opacity-0 
      after:bg-white after:mix-blend-overlay hover:after:opacity-20 
      after:transition-opacity after:duration-300`,
    ...
    ghost: `border border-gray-400 text-[var(--foreground)] hover:bg-gray-800 
      hover:border-[var(--accent-cyan)]/40 hover:-translate-y-1 hover:shadow-md active:translate-y-0 
      active:shadow-none hover:text-white relative
      after:absolute after:inset-0 after:rounded-lg after:opacity-0 
      after:bg-[var(--accent-cyan)]/10 hover:after:opacity-30 
      after:transition-opacity after:duration-300`,
  };
